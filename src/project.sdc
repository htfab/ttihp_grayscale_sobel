...
create_clock [ get_ports "clk" ]  -name main_clk -period $::env(CLOCK_PERIOD)
...
create_clock [ get_ports "ui_in\[0\]" ]  -name spi_clk -period $::env(CLOCK_PERIOD)
...
set_clock_groups -asynchronous -group { main_clk } -group { spi_clk }
